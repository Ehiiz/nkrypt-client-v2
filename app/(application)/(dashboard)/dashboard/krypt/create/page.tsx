...
const CreateKryptForm = () => {
  ...
  // In your CreateKryptForm component, replace the addQuestion function with this fixed version:
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleLockTypeChange(KryptTypeEnum.MULTPLE_CHOICE)
                  }
                  className={`flex items-center px-3 py-3 rounded-md ${
                    kryptData.type === KryptTypeEnum.MULTPLE_CHOICE
                      ? "bg-[#B2F17E] text-[#222227]"
                    ...
                    <div key={index} className="p-3 bg-[#333339] rounded-md">
                      <div className="flex justify-between">
                        <div>
                          ...
                          <p className="text-sm text-[#B2F17E]">
                            Answer: {q.answer}
                          </p>
                          {kryptData.type === KryptTypeEnum.MULTPLE_CHOICE &&
                            q.options.length > 0 && (
